...
namespace FtpClient
{
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.label3.Text = "Начальная директория";
			...
			this.label6.Text = "Отдаленный хост";
			...
			this.cbPassiveMode.Text = "Пассивный режим";
			...
			this.btnOpenDir.Size = new System.Drawing.Size(90, 40);
			this.btnOpenDir.TabIndex = 18;
			this.btnOpenDir.Text = "Открыть директорию";
			this.btnOpenDir.Click += new System.EventHandler(this.btnOpenDir_Click);
			
			this.btnGoUp.Location = new System.Drawing.Point(653, 165);
			this.btnGoUp.Name = "btnGoUp";
			this.btnGoUp.Size = new System.Drawing.Size(90, 50);
			this.btnGoUp.TabIndex = 19;
			this.btnGoUp.Text = "На директорию ниже";
			this.btnGoUp.Click += new System.EventHandler(this.btnGoUp_Click);
			 
			this.btnDownload.Location = new System.Drawing.Point(653, 270);
		...
		private void btnLogin_Click(object sender, System.EventArgs e) {
			if (ftp1.Active) {
				MessageBox.Show("Вы уже подключены. Пожалуйста, нажмите Выход, чтобы отключиться.");
				return;
			}
		...
		private void UpdateStatus() {
			Text = ftp1.Active ? "FTP-клиент — подключен" : "FTP-клиент";
		}
